 ...
 */
@Service
public class PortalPermissionConvert extends BaseConvertFunction<PortalPermission, PortalPermissionVO> {

    @Override
    public PortalPermissionVO apply(PortalPermission input) {
        PortalPermissionVO vo = super.apply(input);
