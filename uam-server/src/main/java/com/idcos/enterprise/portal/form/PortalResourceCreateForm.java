...
/**
 * 表单对象PortalResourceCreateForm
 * <p>第一次由自动生成代码工具初始化，后续可以编辑，再次生成的时候不会进行覆盖</p>
 *
 * @author yanlv
 * @version PortalResourceCreateForm.java, v 1.1 2015-06-09 10:00:37 yanlv Exp $
 */

public class PortalResourceCreateForm extends BaseForm {
