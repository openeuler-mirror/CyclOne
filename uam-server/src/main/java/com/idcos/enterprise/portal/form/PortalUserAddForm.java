...
/**
 * @author souakiragen
 * @version $Id: , v 0.1 2017年11月01 下午8:20 souakiragen Exp $
 */
@ApiModel(value = "新增用户", description = "新增用户")
public class PortalUserAddForm extends BaseForm {
    ...
    @ApiModelProperty(name = "password", value = "密码", notes = "密码", required = true)
    ...
    @ApiModelProperty(name = "confirmPassword", value = "密码", notes = "密码", required = true)
