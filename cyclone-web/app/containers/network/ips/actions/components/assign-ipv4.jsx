...
class AssignIPv4Form extends React.Component {
  handleSubmit = (e) => {
    e.preventDefault();
    this.props.form.validateFields((err, values) => {
      ...
      put('/api/cloudboot/v1/ips/assignsv4', { sn: sn, scope: values.scope }).then(res => {
...
const WrappedAssignIPv4Form = Form.create()(AssignIPv4Form);

export default WrappedAssignIPv4Form;
