...
class Container extends React.Component {
  state = {
    ...
    searchValues: {
      ...
      'input': { type: 'input', placeholder: '查询条件支持英文逗号,空格,换行分隔'},
  ...
  render() {
    const initialSearchList = [{ key: 'radio', keyLabel: '单选', valueLabel: 'A1', value: 'a1' }];
    return (
      <Layout>
        {/*<SearchForm initialSearchList={initialSearchList} initialSearch={false} onSearch={this.onSearch} searchKeys={this.state.searchKeys} searchValues={this.state.searchValues}/>*/}
      </Layout>
    );
  }
}
